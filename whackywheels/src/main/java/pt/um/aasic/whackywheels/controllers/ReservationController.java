...
public class ReservationController {
    ...
    @PreAuthorize("hasAnyRole('USER', 'OWNER')")
    public ResponseEntity<?> updateReservation(@PathVariable Long reservationId, @Valid @RequestBody ReservationCreateRequestDTO request) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        ...
        try {
            ReservationResponseDTO updatedReservationResponse = reservationService.updateReservation(reservationId, request, currentUserId);
    ...
    @PreAuthorize("hasAnyRole('USER', 'OWNER')")
    public ResponseEntity<?> getOccupiedSlots(@Valid @RequestBody OccupiedSlotRequestDTO request) { // Usar @DateTimeFormat para LocalDate
        try {
