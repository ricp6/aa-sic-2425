...
public class TrackUpdateRequestDTO {
    ...
    public TrackUpdateRequestDTO() {}

    public TrackUpdateRequestDTO(String name, BigDecimal slotPrice, Integer slotDuration, String email, String phoneNumber, Set<String> images, Set<DayScheduleDTO> daySchedules) {
        this.name = name;
